...
export default function createAddAdmin({ adminsDb }: { adminsDb: DatabaseEntity<Admin> }) {

    return async function addAdmin(adminInfo: Admin): Promise<DatabaseFunction<DatabaseObject<Required<Admin>>>>{
