...
import { authLogout, authVerify, landlordsDb, tenantsDb,adminsDb} from "../../../database";
...
export { createTenant, createAdmin, createLandlord ,checkTakeUser, takeUser, login, logout };
